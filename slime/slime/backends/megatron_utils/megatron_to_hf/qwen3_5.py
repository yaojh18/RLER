...
def convert_qwen3_5_to_hf(args, name, param):
    ...
    if match:
        ...
        elif rest in {"self_attention.linear_qkv.weight", "self_attention.linear_qgkv.weight"}:
        ...
        elif rest in {"self_attention.linear_qkv.bias", "self_attention.linear_qgkv.bias"}:
        ...
        elif rest in {"self_attention.linear_qkv.layer_norm_weight", "self_attention.linear_qgkv.layer_norm_weight"}:
