...
from swe_agent.agents.utils.prompt_user import _multiline_prompt
...
from swe_agent.run.utilities.config import configure_if_first_time
...
def main(
    ...
    model_class: str | None = typer.Option(None, "--model-class", help="Model class to use (e.g., 'litellm' or 'swe_agent.models.litellm_model.LitellmModel')", rich_help_panel="Advanced"),
    ...
    environment_class: str | None = typer.Option(None, "--environment-class", help="Environment class to use (e.g., 'local' or 'swe_agent.environments.local.LocalEnvironment')", rich_help_panel="Advanced"),
