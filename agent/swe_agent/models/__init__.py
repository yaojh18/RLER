...
_MODEL_CLASS_MAPPING = {
    "litellm": "swe_agent.models.litellm_model.LitellmModel",
    "litellm_textbased": "swe_agent.models.litellm_textbased_model.LitellmTextbasedModel",
    "litellm_response": "swe_agent.models.litellm_response_model.LitellmResponseModel",
    "openrouter": "swe_agent.models.openrouter_model.OpenRouterModel",
    "openrouter_textbased": "swe_agent.models.openrouter_textbased_model.OpenRouterTextbasedModel",
    "openrouter_response": "swe_agent.models.openrouter_response_model.OpenRouterResponseModel",
    "portkey": "swe_agent.models.portkey_model.PortkeyModel",
...
def get_model_class(model_name: str, model_class: str = "") -> type:
    ...
    e.g., "anthropic" or "swe_agent.models.anthropic.AnthropicModel"),
